        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <!--<ul class="treeview-menu">
                <li><a href="/admin/layout/top-nav.html"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-adjust"></i> Room 1</a></li>
                <li><a href="#"><i class="fa fa-adjust"></i> Room 2</a></li>
                <li><a href="#"><i class="fa fa-adjust"></i> Room 3</a></li>
              </ul>
            </li>
            <!--
            <li class="treeview">
