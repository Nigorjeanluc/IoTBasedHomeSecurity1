                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-danger">
                            ...
                            <h3 class="box-title">Latest Intrusions</h3>
                            ...
                            <?php
                                include('../../../connect.php');
                                $query = "SELECT * FROM sensors WHERE HumanDetect = 1 ORDER BY id DESC LIMIT 20";
                                $res = mysqli_query($dbcon, $query);
                                while($row = mysqli_fetch_array($res)){
                                    echo '
                                    <li>
                                    <img src="../img/thiefa.png" alt="User Image">
                                    <span class="users-list-date"><b>Intrusion detecetd at</b></span>
                        ...
                        <?php
                                include('../../../connect.php');
                                $queryy = "SELECT * FROM sensors WHERE HumanDetect = 1 ORDER BY id DESC LIMIT 20";
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Intrusion at '.date('h:i:sA - F dS, Y', strtotime($roww['created_at'])).'</h4>
                                            </div>
                                            <div style="text-align:center" class="modal-body">
                                                <img src="../img/thiefa.png" alt="User Image">
                                                <h1 style="font-family:broadway">Human presence detected at '.date('h:i:sA - F dS, Y', strtotime($roww['created_at'])).'</h1>
                                            </div>
